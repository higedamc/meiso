...
class _$LinkPreviewImpl implements _LinkPreview {
  ...
  @override
  String toString() {
    return 'LinkPreview(url: $url, title: $title, description: $description, imageUrl: $imageUrl, faviconUrl: $faviconUrl)';
  }
  ...
  @override
  int get hashCode =>
      Object.hash(runtimeType, url, title, description, imageUrl, faviconUrl);
