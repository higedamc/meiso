...
mixin _$MediaServer {
  ...
  MediaServerType get type => throw _privateConstructorUsedError;
...
abstract class $MediaServerCopyWith<$Res> {
  ...
  @useResult
  $Res call({String url, MediaServerType type, bool isManual});
}
...
class _$MediaServerImpl implements _MediaServer {
  const _$MediaServerImpl({
    required this.url,
    this.type = MediaServerType.blossom,
    this.isManual = false,
  });
  ...
  @override
  String toString() {
    return 'MediaServer(url: $url, type: $type, isManual: $isManual)';
  }
  ...
  @JsonKey(includeFromJson: false, includeToJson: false)
  @override
  int get hashCode => Object.hash(runtimeType, url, type, isManual);
