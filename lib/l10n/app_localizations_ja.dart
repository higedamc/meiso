...
class AppLocalizationsJa extends AppLocalizations {
  ...
  @override
  String get onboardingWelcomeDescription => 'シンプルで美しいToDoアプリ\nNostrで同期して、どこでもタスク管理';

  @override
  String get onboardingNostrSyncTitle => 'Nostrで同期';

  @override
  String get onboardingNostrSyncDescription => 'あなたのタスクをNostrネットワークで同期\n複数デバイスで自動的に最新状態を保ちます';

  @override
  String get onboardingSmartDateTitle => 'スマートな日付入力';

  @override
  String get onboardingSmartDateDescription => 'タスクに \"tomorrow\" と入力すれば明日のタスクに\n\"every day\" で繰り返しタスクも簡単に作成';

  @override
  String get onboardingPrivacyTitle => 'プライバシー第一';

  @override
  String get onboardingPrivacyDescription => '中央サーバーなし。すべてのデータはあなたの管理下に\nNostrの分散型ネットワークで安全に保管';

  @override
  String get onboardingGetStartedTitle => 'さあ、始めましょう';

  @override
  String get onboardingGetStartedDescription => 'Amberでログインするか、\n新しい秘密鍵を生成してスタート';
  ...
  @override
  String get amberNotInstalled => 'Amberアプリがインストールされていません。\nGoogle Playからインストールしますか？';
  ...
  @override
  String get torEnabledMessage => 'Torを有効にしました。次回接続時から適用されます。\nOrbotアプリを起動してください。';
  ...
  @override
  String get commonSettings => '一般的な設定:\n• Orbot: 127.0.0.1:9050\n• カスタムプロキシ: ホストとポートを入力';
  ...
  @override
  String get invalidSecretKeyFormat => '秘密鍵のフォーマットが正しくありません。nsecまたはhex形式で入力してください。';
